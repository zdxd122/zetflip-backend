      ...
      >
        ...
        <div className="Info">
          <div className="List">
            ...
            <p className="ListItem">
              <p className="Title">Can AdoptFlip be rigged?</p>
              <p className="Text">
                AdoptFlip itself has no impact on the outcome of particular games.
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                AdoptFlip takes a cut of 0-10% of every game to keep the site
                functional.
              </p>
            </p>
            <p className="ListItem">
              ...
              <p className="Text">
                In Adopt me, the market changes a lot. With this, so do
            ...
            <p className="ListItem">
              <p className="Title">
                I am a Adopt me content creator and I am looking for a sponsorship.
              </p>
              <p className="Text">
