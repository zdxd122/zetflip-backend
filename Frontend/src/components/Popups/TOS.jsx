        ...
        <div className="Info">
          <div className="List">
            <p className="ListItem">
              ...
              <p className="Text">
                By using AdoptFlip.com you agree to the following Terms of
                Service. If you do not agree with these Terms of Service, you
                are not allowed to use AdoptFlip.com. You must be at least 18
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                ...
                AdoptFlip.com is for entertainment purposes only. AdoptFlip.com does
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                ...
                termination of the Adopt me Bots.
              </p>
            </p>
            <p className="ListItem">
