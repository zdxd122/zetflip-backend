...
export default function Profile({ closeModal, userId }) {
  ...
  useEffect(() => {
    // Don't fetch profile data for guest users
    if (!userId) {
      setData(null);
      return;
    }
      ...
      {data ? (
        ...
        >
          <div className="Header">
            <div className="Profile">
              <img
                src="https://www.roblox.com/headshot-thumbnail/image?userId=1&width=420&height=420&format=png"
              ...
              <div className="Info">
                ...
                <div className="Stats">
                  ...
                  <input
                    ...
                    aria-readonly
                    style={{
                      background: `linear-gradient(to right, #FF7575 0%, #D42626 0%, #211936 0%)`,
                      borderRadius: "2px",
                    }}
                  />
                  <p className="JoinDate">
                    Status: <span>Guest Account</span>
                  </p>
                </div>
              </div>
              <button className="CloseButton" onClick={closeModal}>×</button>
